...
var Glow = function() {
  ...
  Glow2.prototype._renderX = function(strength) {
    ...
    var opacity = (0, import_lodash.default)(Math.abs(strength) / maxOverscroll, 0, GLOW_MAX_OPACITY);
    var startOffset = (0, import_lodash.default)(opacity, 0, GLOW_MAX_OFFSET) * width;
...
var OverscrollPlugin = function(_super) {
  ...
  function OverscrollPlugin2() {
    ...
    _this._releaseWheel = (0, import_lodash3.default)(function() {
  ...
  OverscrollPlugin2.prototype._willOverscroll = function(direction, delta) {
    ...
    return (0, import_lodash2.default)(offset + delta, 0, limit) === offset && (offset === 0 || offset === limit);
  };
  OverscrollPlugin2.prototype._absorbMomentum = function(direction, remainMomentum) {
    ...
    _amplitude[direction] = (0, import_lodash2.default)(remainMomentum, -options.maxOverscroll, options.maxOverscroll);
  };
  OverscrollPlugin2.prototype._addAmplitude = function(direction, delta) {
    ...
    _amplitude[direction] = scrollbar.offset[direction] === 0 ? (0, import_lodash2.default)(amp, -options.maxOverscroll, 0) : (0, import_lodash2.default)(amp, 0, options.maxOverscroll);
    if (isOpposite) {
