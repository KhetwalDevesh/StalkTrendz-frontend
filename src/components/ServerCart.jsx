...
const ServerCart = () => {
  ...
  console.log(`serverCartItems`, JSON.stringify(serverCartItems, null, 2));
  console.log(`renderCount`, JSON.stringify(renderCount, null, 2));
  return (
      ...
      <div className="p-10 ">
        {serverCartItems.map((item) => {
          ...
          return (
            ...
            >
              <div className="xl:gap-20 lg:gap-16 grid grid-cols-5 gap-28">
                <img
                  src={item.image}
                  alt=""
                  className="lg:h-28 lg:w-68 xl:h-40 xl:w-64 h-52 w-52"
                />
                ...
                <span className="xl:w-44 flex justify-center items-center">
                  <button
                    ...
                    className="xl:w-16 w-6 bg-slate-700 text-white rounded-full"
                  >
                    -
                  </button>
                  <span className="xl:text-[15px] xl:w-[300px] p-3 m-1 bg-indigo-900 text-white rounded-full flex justify-center">
